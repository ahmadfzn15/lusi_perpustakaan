            ...
            <table class="w-full overflow-hidden rounded-md ring-1 ring-slate-300">
                ...
                <tbody>
                    ...
                    <tr class="text-slate-600">
                        ...
                        <td class="whitespace-nowrap border border-slate-300 p-2 text-center">{{ $item->no_tlp }}</td>
                    ...
                    @else
                    <tr class="text-slate-600">
                        <td colspan="5" class="whitespace-nowrap border border-slate-300 p-2 text-center">Data kosong
                        </td>
                    </tr>
                    @endif
                </tbody>
